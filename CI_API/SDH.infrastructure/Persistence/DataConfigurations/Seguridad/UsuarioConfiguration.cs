...
{
    /// <summary>
    /// Configuraci�n de EF Core para la entidad Usuario - Solo configuraciones no soportadas por Data Annotations
    /// </summary>
    public class UsuarioConfiguration : IEntityTypeConfiguration<Users>
    {
        public void Configure(EntityTypeBuilder<Users> builder)
        {
            ...
            // 5. �ndices Recomendados (Opcional, pero muy recomendado para seguridad)
            ...
            // �ndices �nicos (no soportado por Data Annotations)
            builder.HasIndex(u => u.Username)
                .IsUnique()
                .HasDatabaseName("IX_Usuario_CodigoUsuario");

            // Configuraci�n adicional para b�squedas
