namespace contactabilidad_inteligente.mcv.Pages.Auth
{
    ...
    public static class SecurityConfig
    {
        ...
        public static readonly Dictionary<string, string> ErrorMessages = new()
        {
            ...
            { "AccountLocked", "La cuenta est� bloqueada. Intente m�s tarde." },
            { "InvalidEmail", "El formato del correo electr�nico no es v�lido." },
            { "WeakPassword", "La contrase�a no cumple con los requisitos de seguridad." },
            { "DuplicateEmail", "Ya existe una cuenta con este correo electr�nico." },
            { "UserNotFound", "Usuario no encontrado." },
            { "SessionExpired", "Su sesi�n ha expirado. Por favor, inicie sesi�n nuevamente." },
            { "TooManyAttempts", "Demasiados intentos fallidos. Intente m�s tarde." },
            { "InternalError", "Error interno del servidor. Por favor, intente m�s tarde." },
            { "EmailNotVerified", "Por favor, verifique su correo electr�nico antes de iniciar sesi�n." },
            { "TwoFactorRequired", "Autenticaci�n de dos factores requerida." }
        };
        ...
        public static (bool IsValid, List<string> Errors) ValidatePasswordStrength(string password)
        {
            ...
            if (password.Length < MinPasswordLength)
                errors.Add($"La contrase�a debe tener al menos {MinPasswordLength} caracteres.");

            if (password.Length > MaxPasswordLength)
                errors.Add($"La contrase�a no puede exceder {MaxPasswordLength} caracteres.");
            ...
            if (RequireSpecialChar && !password.Any(c => !char.IsLetterOrDigit(c)))
                errors.Add("La contrase�a debe contener al menos un car�cter especial.");
